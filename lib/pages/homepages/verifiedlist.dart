...
class VerifiedListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<Scancontroller>(builder: (scancontroller) {
      return SizedBox(
        // appBar: AppBar(
        //   title: const Text('Verified List'),
        // ),
        child: scancontroller.permitlistLoading
            ?
            //  const Center(
            ...
            : Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Scanned Permits",
                      style: TextStyle(fontSize: 20, color: greencol),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Row(
                      children: [
                        ...
                        RoundedCard(
                          onPress: () {
                            scancontroller
                                .searchlistFilter(verifylistFilter.all);
                          },
                          title: "Total",
                          isSelected: scancontroller.verifiedList ==
                              verifylistFilter.all,
                        ),
                        RoundedCard(
                          onPress: () {
                            scancontroller
                                .searchlistFilter(verifylistFilter.verified);
                          },
                          title: "Verified",
                          isSelected: scancontroller.verifiedList ==
                              verifylistFilter.verified,
                        ),
                        RoundedCard(
                          onPress: () {
                            scancontroller
                                .searchlistFilter(verifylistFilter.expired);
                          },
                          title: "Expired",
                          isSelected: scancontroller.verifiedList ==
                              verifylistFilter.expired,
                        ),
                        RoundedCard(
                          onPress: () {
                            scancontroller
                                .searchlistFilter(verifylistFilter.fake);
                          },
                          title: "Fake",
                          isSelected: scancontroller.verifiedList ==
                              verifylistFilter.fake,
                        ),
                      ],
                    ),
                  ),
                  // SizedBox(height: 20,),
                  scancontroller.getmypermitsFilter.isEmpty
                      ? const Padding(
                      ...
                      : Expanded(
                          child: SingleChildScrollView(
                            ...
                            child: ListView(
                                ...
                                shrinkWrap: true,
                                children: scancontroller.getmypermitsFilter
                                    .map(
                                      (d) => RoundedCard(
                                        ...
                                        child: ListTile(
                                          onTap: () {
                                            scancontroller.fetchPermitById(
                                                'TAL202412050058783');
                                            Get.to(() =>
                                          ...
                                          subtitle: Text(
                                              '${d.dateTime?.day}/${d.dateTime?.month}/${d.dateTime?.year}'),
                                        ),
                                      ),
                                    )
                                    .toList()),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            gradient: isSelected || isGradient ? LinearGradient(
                ...
                colors: [Colors.blue[400]!, Colors.blue, Colors.blue[800]!]) : null,
