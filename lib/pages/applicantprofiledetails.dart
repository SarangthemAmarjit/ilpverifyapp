                          ...
                          children: [
                            Row(
                               ...
                               decoration: BoxDecoration(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                             const Expanded(child: Text("Issued",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,)),
                                                Expanded(child: const Text("Upto",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),textAlign: TextAlign.center,)),
                                      ],
                                    ),
                                    Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(children: [
                                                                    ...
                                                                    Text(dateTimetoString(controller.allgetiltpdata!.issueDate),textAlign: TextAlign.center,style:  const TextStyle(color: Colors.white,fontSize: 16),)                              
                                            ],),
                                          ...
                                          Container(
                                            ...
                                            width: 0.5,height: 40, margin: const EdgeInsets.symmetric(vertical: 8,horizontal: 8),color: Colors.white,),
                                                    Expanded(
                                            child: Column(children: [
                                              
                                                                    const SizedBox(height: 20,),
                                                                    Text(dateTimetoString(controller.allgetiltpdata!.validDate),textAlign: TextAlign.center,style:  const TextStyle(color: Colors.white,fontSize: 16),) 
                                            ],),
                              ...
                              Container(
                               ...
                               decoration: BoxDecoration(
                                 borderRadius: BorderRadius.circular(8),
                                 color:controller.isfake || remainingDays(controller.allgetiltpdata!.validDate)<1?Colors.red:Colors.green,
                              
                                     gradient: LinearGradient(
                                       begin: Alignment.bottomRight,
                                       end: Alignment.topLeft,
                                       colors: [controller.isfake || remainingDays(controller.allgetiltpdata!.validDate)<1?Colors.red[200]!:Colors.green[300]!,controller.isfake || remainingDays(controller.allgetiltpdata!.validDate)<1?Colors.red:Colors.green]),
                               ),
                                child: Row(
                                  children: [
                                    Icon(controller.isfake  || remainingDays(controller.allgetiltpdata!.validDate)<1? FontAwesomeIcons.exclamation:Icons.check_circle_outline_outlined,color: Colors.white,size:  18,),
                                    const SizedBox(width: 10,),
                                    Text(controller.isfake?"Card Not Valid": remainingDays(controller.allgetiltpdata!.validDate)<1?"Card is Expired" : "Card is Valid",style: const TextStyle(color: Colors.white,fontSize: 20),),
                                  ],
                                )
                              ),
